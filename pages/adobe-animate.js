...
function AdobeAnimate({ links, authenticated }) {
        ...
        <>
            <main>
                    ...
                    <Slider {...settings} ref={(slider) => (sliderefd.current = slider)} className="bg-single-slick adobeAnimate">
                        <AnimatePresence exitBeforeEnter={true} >
                            <motion.div key={activeSlide}>
                                ...
                                <div className="nav-light"><NavSec setclickedRoute={setclickedRoute} setisAuthenticated={setisAuthenticated} setisContactClicked={setisContactClicked} destination={`destination=/adobe-animate?slide=${activeSlide}`} /></div>
                                <Container>
                ...
                <div className="main-wrapper animate-wrapper-mobile  mobile-version p-0 pb-5" >
                    <MobileNav setclickedRoute={setclickedRoute} setisAuthenticated={setisAuthenticated} setisContactClicked={setisContactClicked} destination={`destination=/adobe-animate?slide=${activeSlide}`} />
                    <div className=" br-0" >

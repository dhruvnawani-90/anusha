...
function AdobeCustomerStories({ links, authenticated }) {
        ...
        <>
            <main>
                    ...
                    <Slider {...settings} ref={(slider) => (sliderefd.current = slider)} className="acs-slick ad-slick customerStories">
                        <AnimatePresence exitBeforeEnter={true} >
                            <motion.div key={activeSlide}>
                                <NavSecDark setclickedRoute={setclickedRoute} setisAuthenticated={setisAuthenticated} setisContactClicked={setisContactClicked} destination={`destination=/adobe-customer-stories?slide=${activeSlide}`} />
                        ...
                        <AnimatePresence exitBeforeEnter={true} >
                            <motion.div key={activeSlide}>
                                <div className="nav-light"><NavSec setclickedRoute={setclickedRoute} setisAuthenticated={setisAuthenticated} setisContactClicked={setisContactClicked} destination={`destination=/adobe-customer-stories?slide=${activeSlide}`} /></div>
                                <Container>
                ...
                <div className="main-wrapper acs-nav mobile-version p-0">
                    <MobileNavDark setclickedRoute={setclickedRoute} setisAuthenticated={setisAuthenticated} setisContactClicked={setisContactClicked} destination={`destination=/adobe-customer-stories?slide=${activeSlide}`} />

...
function Captivate({ authenticated }) {
        ...
        <>
            ...
            <main>
                    ...
                    <Slider {...settings} ref={(slider) => (sliderefd.current = slider)} className="other-projects">
                        <AnimatePresence exitBeforeEnter={true} >
                            <motion.div key={activeSlide}>
                                <div className="nav-light"><NavSec setclickedRoute={setclickedRoute} setisAuthenticated={setisAuthenticated} setisContactClicked={setisContactClicked} destination={`destination=/other-projects?slide=${activeSlide}`} /></div>
                ...
                <div className="main-wrapper other-projects-mobile  mobile-version p-0 pb-0" >
                    <MobileNav setclickedRoute={setclickedRoute} setisAuthenticated={setisAuthenticated} setisContactClicked={setisContactClicked} destination={`destination=/other-projects?slide=${activeSlide}`} />

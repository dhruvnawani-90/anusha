    ...
    return (
        <main>
                ...
                <Slider {...settings} ref={(slider) => (sliderefd.current = slider)} className="ad-slick captivate-slider adobe-captivate">
                    <AnimatePresence exitBeforeEnter={true} >
                        <motion.div key={activeSlide}>
                            <NavSecDark destination={`destination=/adobe-captivate?slide=${activeSlide}`} />
                            <Container>
                    ...
                    <AnimatePresence exitBeforeEnter={true} >
                        <motion.div key={activeSlide} className="w-100">
                            <div className="contact-sec-nav"><NavSecDark destination={`destination=/adobe-captivate?slide=${activeSlide}`} /></div>
                            <Container>
                                <Row>
            ...
            <div className="main-wrapper white mobile-version p-0" >
                <MobileNavDark destination={`destination=/adobe-captivate?slide=${activeSlide}`}/>
                <div className=" br-0" >
